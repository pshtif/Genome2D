...
public class GTexture extends GContextTexture
{
    static public function getTextureById(p_id:String):GTexture {
        return GContextTexture.getTextureBaseById(p_id) as GTexture;
    }
	...
	public function GTexture(p_context:IContext, p_id:String, p_sourceType:int, p_source:*, p_region:Rectangle, p_pivotX:Number = 0, p_pivotY:Number = 0, p_parentAtlas:GTextureAtlas = null) {
		super(p_context, p_id, p_sourceType, p_source, p_region, p_pivotX, p_pivotY);
