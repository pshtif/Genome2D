...
public class GTextureFactory {
    ...
    static public function createFromEmbedded(p_id:String, p_asset:Class):GTexture {
        var bitmap:Bitmap = new p_asset();

        return new GTexture(g2d_context, p_id, GTextureSourceType.BITMAPDATA, bitmap.bitmapData, bitmap.bitmapData.rect);
    }

	static public function createFromBitmapData(p_id:String, p_bitmapData:BitmapData):GTexture {
		return new GTexture(g2d_context, p_id, GTextureSourceType.BITMAPDATA, p_bitmapData, p_bitmapData.rect);
	}
    ...
    static public function createFromATF(p_id:String, p_atfData:ByteArray, p_uploadCallback:Function = null):GTexture {
        ...
        return new GTexture(g2d_context, p_id, type, p_atfData, new Rectangle(0, 0, width, height), 0, 0, null);
    }

    static public function createRenderTexture(p_id:String, p_width:int, p_height:int):GTexture {
        return new GTexture(g2d_context, p_id, GTextureSourceType.RENDER_TARGET, null, new Rectangle(0,0,p_width, p_height));
    }
}
}